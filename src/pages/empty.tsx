				...
				<div className="container mx-auto px-4 md:px-8">
					...
					<div className="max-w-4xl mx-auto text-center">
						...
						<p className="text-xl text-gray-600 mb-8">
							Transforming a complex financial management application into an intuitive and engaging experience.
						</p>
					...
					<div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
						<div className="bg-white p-6 rounded-xl shadow-sm">
							...
							<p className="text-gray-600">
								Transform a complex financial management application into an intuitive and engaging experience for 200,000+ users globally.
							</p>
						</div>
						<div className="bg-white p-6 rounded-xl shadow-sm">
				...
				<div className="container mx-auto px-4">
					<div className="max-w-4xl mx-auto">
						...
						<p className="text-lg text-gray-700 mb-8">
							A deep dive into the design process and key decisions that shaped the financial app redesign.
						</p>
						<DesignProcessScroller
							images={[
								"/images/fintrack/process/1.png",
								"/images/fintrack/process/2.png",
								"/images/fintrack/process/3.png",
								"/images/fintrack/process/4.png",
								"/images/fintrack/process/5.png"
							]}
						/>
					</div>
				</div>
