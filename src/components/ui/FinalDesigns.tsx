    ...
    <div className={cn("relative w-full overflow-hidden", className)}>
      <div className="flex h-full items-center justify-center">
        ...
        <div className="relative w-full flex justify-center items-center py-8">
          {/* Left (previous) image */}
          {!isMobile && (
            <div className="hidden sm:block absolute left-0 w-1/5 z-10 transform transition-all duration-500 ease-in-out opacity-60 hover:opacity-70">
              <img
          ...
          {/* Center (current) image - LARGER than in PersonaGallery */}
          <div className="w-full sm:w-3/5 z-20 transform transition-all duration-500 ease-in-out mx-auto px-4 sm:px-0">
            <img
          ...
          {/* Right (next) image */}
          {!isMobile && (
            <div className="hidden sm:block absolute right-0 w-1/5 z-10 transform transition-all duration-500 ease-in-out opacity-60 hover:opacity-70">
              <img
